    ...
    (function (H) {
        ...
        function isSkipPoint(point) {
            return point.isNull &&
                ...
                point.series.options.skipKeyboardNavigation || !point.series.visible;
        }
        ...
        H.Chart.prototype.highlightExportItem = function (ix) {
            ...
            if (
                listItem &&
                listItem.tagName === 'DIV' && !(listItem.children && listItem.children.length)
            ) {
                if (listItem.focus) {
                    listItem.focus();
                }
        ...
        H.Chart.prototype.addKeyboardNavEvents = function () {
            ...
            chart.keyboardNavigationModules = [
                ...
                navModuleFactory('legend', [
                    ...
                    validate: function () {
                        return chart.legend && chart.legend.allItems && !(chart.colorAxis && chart.colorAxis.length) &&
            ...
            if (
                chart.container.hasAttribute && !chart.container.hasAttribute('tabIndex')
            ) {
