...
(function (factory) {
    ...
    (function (H) {
        ...
        function GLRenderer(postRenderCallback) {
            ...
            function pushSeriesData(series, inst) {
                ...
                while (i < sdata.length - 1) {
                    ...
                    if (!settings.useGPUTranslations && !settings.usePreallocated &&
        ...
        function renderIfNotSeriesBoosting(renderer, series, chart) {
            if (renderer &&
                series.renderTarget &&
                series.canvas && !isChartSeriesBoosting(chart || series.chart)
            ) {
        ...
        function allocateIfNotSeriesBoosting(renderer, series) {
            if (renderer &&
                series.renderTarget &&
                series.canvas && !isChartSeriesBoosting(series.chart)
            ) {
