...
(function (factory) {
    ...
    (function (Highcharts) {
        ...
        Highcharts.downloadURL = function (dataURL, filename) {
            ...
            if (
                typeof dataURL !== 'string' && !(dataURL instanceof String) &&
        ...
        Highcharts.imageToDataUrl = function (imageURL,
                                              imageType,
                                              callbackArgs,
                                              scale,
                                              successCallback,
         ...
         *   demand
         */
        Highcharts.downloadSVGLocal = function (svg,
                                                options,
                                                failCallback,
                                                successCallback) {
            var svgurl,
        ...
        Highcharts.Chart.prototype.getSVGForLocalExport = function (options,
                                                                    chartOptions,
                                                                    failCallback,
                                                                    successCallback) {
            var chart = this,
         ...
         *         for export only.
         */
        Highcharts.Chart.prototype.exportChartLocal = function (exportingOptions,
                                                                chartOptions) {
            var chart = this,
