...
(function (factory) {
    ...
    (function (H) {
         ...
         */
        H.Renderer.prototype.symbols['navigator-handle'] = function (x,
                                                                     y,
                                                                     w,
                                                                     h,
                                                                     options) {
        ...
        Navigator.prototype = {
            ...
            updateNavigatorSeries: function (redraw) {
                ...
                // base series.
                if (
                    chartNavigatorSeriesOptions.data && !(baseSeries && baseSeries.length) ||
                    isArray(chartNavigatorSeriesOptions)
                ) {
                    ...
                    each(chartNavigatorSeriesOptions, function (userSeriesOptions, i) {
                        ...
                        mergedNavSeriesOptions = merge(
                            defaultOptions.navigator.series, {
                                ...
                                color: chart.series[i] && !chart.series[i].options.isInternal &&
        ...
        wrap(Series.prototype, 'addPoint', function (proceed,
                                                     options,
                                                     redraw,
                                                     shift,
                                                     animation) {
